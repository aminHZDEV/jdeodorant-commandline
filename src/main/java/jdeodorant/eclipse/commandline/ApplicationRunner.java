...
import jdeodorant.eclipse.commandline.coverage.CoverageStatus;
import jdeodorant.eclipse.commandline.coverage.LineCoverage;
import jdeodorant.eclipse.commandline.coverage.TestReport;
import jdeodorant.eclipse.commandline.coverage.TestReportResults;
import jdeodorant.eclipse.commandline.utility.IOHelper;
import jdeodorant.eclipse.commandline.utility.SourceDirectoryUtility;
...
//		clearProcesses.invoke(fProcessesValue);
	...
	private void createRunnableClass(String className, String statement) throws CoreException, JavaModelException {
		...
		buffer.append("import jdeodorant.coverage.tools.TestAndCoverageEngine;");
		buffer.append("\n");
